...
export default class MongoDatabaseTest extends AbstractDatabaseTest {
	...
	protected static async canCreateMultiFieldUniqueIndex(connect: TestConnect) {
	...
	protected static async cantCreateSameUniqueIndexTwice(connect: TestConnect) {
	...
	protected static async syncIndexesSkipsExistingIndexes(connect: TestConnect) {
		await databaseAssertUtil.assertSyncIndexesSkipsExisting(connect)
	}

	@test('syncIndexes removes extra indexes (neDb)', neDbConnect)
	protected static async syncIndexesRemovesExtraIndexes(connect: TestConnect) {
